        ...
        <Layout>
            ...
            <div className="about">
                ...
                <p>
                    ...
                    <br/><br/>
                    Collabora con riviste di informatica e cura la rubrica tecnologica del quotidiano Il Messaggero. Ha
                    pubblicato per Mondadori e Mondadori Informatica.
                    <br/><br/>
                    È il fondatore di Aranzulla.it, uno dei trenta siti più visitati d’Italia, nel quale risponde con
                ...
                <img style={{marginBottom: '5rem'}} src={'https://www.aranzulla.it/wp-content/contenuti/2020/02/salvatore_aranzulla_grande.jpg'}/>
            </div>
        </Layout>
    )
}